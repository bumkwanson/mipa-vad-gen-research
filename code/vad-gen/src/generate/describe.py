...
FORBIDDEN_OUTPUT_TERMS = (
    'previous', 'before', 'from the', 'move', 'moving', 'lowered',
    'atmosphere', 'mood', 'feel', 'intent', 'because',
    'face', 'brow', 'eye', 'lip', 'jaw', 'shoulder', 'breath', 'collar',
)
...
class DescriptionGenerator:
    ...
    def _gen_one(self, item, prev_obs, temperature=0.1):
